...
const gameOver = (isVictory) =>{
    //after 600ms of game complete...showing with relevent details
    setTimeout(() => {
...
const initGame = (button, clickedLetter) =>{
    ...
    if(currentWord.includes(clickedLetter)){
       ...
       //if clicked letter doesnot exist then update the wrongcount and hangman image
       wrongGuessCount++;
       hangmanImage.src = `images/hangman-${wrongGuessCount}.svg`
...
// keyboard button and adding eventlistener
